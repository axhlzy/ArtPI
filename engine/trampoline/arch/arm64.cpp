...
void Arm64TrampolineInstaller::InitTrampolines() {
    ...
    kNativeBridgeTrampoline = AS_VOID_PTR(pine_native_bridge_trampoline);
    kNativeBridgeTrampolineOriginEntryOffset = NativeBridgeTrampolineOffset(
            AS_VOID_PTR(pine_native_bridge_trampoline_origin_entry));
    kNativeBridgeTrampolineCallbackOffset = NativeBridgeTrampolineOffset(
            AS_VOID_PTR(pine_native_bridge_trampoline_callback));
